...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict with trained Slovene Task A model.")
    parser.add_argument("--model", default="slovene_pipeline/model_taskA.joblib")
    parser.add_argument("--input", default="datasets/slovene/test_TaskA/SemEval2018-T3_input_test_taskA_emoji.txt")
