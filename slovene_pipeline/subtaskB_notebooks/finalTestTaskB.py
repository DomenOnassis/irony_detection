...
def wvVectors(corpus):
    ...
    wvModel = Word2Vec.load_word2vec_format('../../w2v-slo/all-token-prelim.ft.sg.bin', binary=True)
...
if __name__ == "__main__":
    ...
    #DATASET_FP = "../../datasets/slovene/train/SemEval2018-T4-train-taskA.txt"
    # DATASET_FP = "../../datasets/slovene/train/SemEval2018-T4-train-taskA_emoji.txt"
    DATASET_FP = "../../datasets/slovene/train/SemEval2018-T4-train-taskB_emoji.txt"
    ...
    test_corpus  = parse_dataset('../../datasets/slovene/test_TaskB/SemEval2018-T3_input_test_taskB_emoji.txt')
